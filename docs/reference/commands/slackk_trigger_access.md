...
```
slackk trigger access --trigger-id <id> [flags]
```
...
$ slackk trigger access --trigger-id Ft01234ABCD --everyone

# Grant certain channels access to run a trigger
$ slackk trigger access --trigger-id Ft01234ABCD --grant \
    --channels C012345678

# Revoke certain users access to run a trigger
$ slackk trigger access --trigger-id Ft01234ABCD --revoke \
