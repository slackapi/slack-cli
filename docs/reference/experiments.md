...
* **December 2025**: Added read-only collaborator support to the Slack CLI and removed the features from behind the experiment flag. See the changelog announcement [here](https://docs.slack.dev/changelog/2025/12/04/slack-cli).
* **June 2025**:
