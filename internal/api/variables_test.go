...
func TestClient_AddVariable_Ok(t *testing.T) {
	...
	defer teardown()
	err := c.AddVariable(context.Background(), "token", "A123", "dummy_var", "dummy_val")
...
func TestClient_AddVariable_HTTPResponseInvalid(t *testing.T) {
	...
	defer teardown()
	err := c.AddVariable(context.Background(), "token", "", "", "")
	require.Error(t, err)
...
func TestClient_ListVariables_Ok(t *testing.T) {
	...
	defer teardown()
	VariableNames, err := c.ListVariables(context.Background(), "token", "A123")
	require.NoError(t, err)
...
func TestClient_ListVariables_NotOk(t *testing.T) {
	...
	defer teardown()
	_, err := c.ListVariables(context.Background(), "token", "A123")
	require.Error(t, err)
	require.Contains(t, err.Error(), "unknown_error")
}
...
func TestClient_ListVariables_HTTPResponseInvalid(t *testing.T) {
	...
	defer teardown()
	_, err := c.ListVariables(context.Background(), "token", "")
	require.Error(t, err)
	require.Contains(t, err.Error(), "http_response_invalid")
}
...
func TestClient_RemoveVariable_Ok(t *testing.T) {
	...
	defer teardown()
	err := c.RemoveVariable(context.Background(), "token", "A123", "dummy_var_name")
	require.NoError(t, err)
}
...
func TestClient_RemoveVariable_HTTPResponseInvalid(t *testing.T) {
	...
	defer teardown()
	err := c.RemoveVariable(context.Background(), "token", "", "")
	require.Error(t, err)
	require.Contains(t, err.Error(), "http_response_invalid")
}
