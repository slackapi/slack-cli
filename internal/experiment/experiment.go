...
const (
	...
	// ManageSandboxes experiment lets users who have joined the Slack Developer Program use the CLI to manage their sandboxes.
	ManageSandboxes Experiment = "manage-sandboxes"
